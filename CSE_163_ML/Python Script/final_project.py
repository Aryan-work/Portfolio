...
Original file is located at
    https://colab.research.google.com/drive/1tKNPOreSOnnyzNnFrDDKAJF3RXcd6sBb
"""
...
features = pd.concat([one_hot,two_hot,three_hot,int_features],axis=1)
...
GS = GridSearchCV(estimator=model_coords_R,param_grid=params,cv=5,n_jobs=-1,
                  verbose=True)
